        ...
        >
            ...
            <div className="flex-1 overflow-auto p-4">
                <div className="list-container flex flex-col h-full space-y-0">
                    ...
                    {/* Shown where the list will appear. The old indicator sat
                        below a flex spacer at the very bottom of the sidebar,
                        so a slow scan looked like the app had hung. */}
                    {vectorSetState.loading && !isCollapsed && (
                        <div className="flex items-center gap-2 p-3 text-sm text-gray-500">
                            ...
                            <span>Scanning keyspace for vector sets…</span>
                        </div>
                    )}
